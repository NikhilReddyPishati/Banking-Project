...
def withdraw():     #New Function
    ...
    if withdraw_amount > balance:   #compares the difference 
        ...
        print(f"sorry sir/mam You need to maintain minimum balance and Available balance is {balance}") #Prints the balance 
...
def deposit(): #It prints Incorrect Pin
    ...
    pin = int(input("please enter your secret pin ")) #Pin Input From the User
    if pin == 0000: #Second verification of secret pin 
...
>>>>>>> 13e77521c6687b80592651e8a19c85d6004a53eb
